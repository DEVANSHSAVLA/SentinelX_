      ...
      <div className="bg-slate-900 border border-slate-700/80 rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl space-y-4">
        ...
        <div className="flex justify-between items-center bg-slate-850 px-6 py-4 border-b border-slate-800">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 font-mono">OAuth 2.0 & OpenID Connect Verified Service</p>
            </div>
          </div>
          <button
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="space-y-2">
            <label className="text-[11px] font-bold text-slate-400 uppercase tracking-wider block">One-Click Google Account Preset</label>
              ...
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="text-left text-[11px]">
                    ...
                    <p className="text-[9px] text-slate-400 font-mono">ADMIN ACCESS</p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="text-left text-[11px]">
                    ...
                    <p className="text-[9px] text-slate-400 font-mono">CITIZEN ACCESS</p>
                  </div>
                </div>
          ...
          <div className="relative border-t border-slate-800 pt-3">
            <span className="absolute -top-2.5 left-1/2 -translate-x-1/2 bg-slate-900 px-2 text-[10px] text-slate-500 font-semibold uppercase">
              Or {authMode === 'SIGN_IN' ? 'Sign In with Google Account' : 'Register New Google Identity'}
            </span>
          </div>

          {/* FORM: GOOGLE SIGN IN / SIGN UP */}
          <form onSubmit={handleGoogleSubmit} className="space-y-3 text-xs">
            ...
            >
              ...
              <span>{authMode === 'SIGN_IN' ? 'Sign In with Google Account' : 'Register & Create Google Account'}</span>
            </button>
          </form>
        </div>
      </div>
